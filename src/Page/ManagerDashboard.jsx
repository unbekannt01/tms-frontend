      ...
      <Box sx={{ maxWidth: 1000, mx: "auto" }}>
        ...
        <Paper
          ...
          sx={{
            ...
            color: "#ffffff",
            boxShadow: "0 10px 25px -5p× rgba(217, 119, 6, 0.3)",
          }}
        >
          <Box
            sx={{
          ...
          <Grid item xs={12} md={6}>
            <Card
              ...
              sx={{
                ...
                boxShadow:
                  "0 4px 6px -1p× rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)",
              ...
              <CardContent sx={{ p: 3 }}>
                ...
                <Box sx={{ space: 2 }}>
                  ...
                  >
                    ...
                    {user.roleId?.name?.toUpperCase() || "MANAGER"}
                  </Typography>
                  <Typography
                    variant="body1"
                    sx={{ mb: 1.5, color: "#374151" }}
                  ...
                  <Typography variant="body1" sx={{ color: "#374151" }}>
                    ...
                    {user.roleId?.displayName || "Management"}
                  </Typography>
                </Box>
              </CardContent>
            </Card>
